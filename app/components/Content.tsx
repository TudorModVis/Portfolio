        ...
        <>
            ...
            <div className="fixed top-0 pt-10 left-1/2 -translate-x-1/2">
                <nav className="flex justify-center gap-4">
                    <button className="rounded-3xl text-blue py-3 px-6 bg-white leading-none font-bold hover:text-white hover:bg-transparent border border-white transition duration-300">TUDORACHE</button>
                    ...
                    <button className="rounded-3xl text-blue py-3 px-6 bg-white leading-none font-bold hover:text-white hover:bg-transparent border border-white transition duration-300">SAY HELLO</button>
                </nav>
                <div className="w-fit mx-auto hidden" ref={menu}>
                    <div className="mt-4 rounded-3xl py-10 px-24 bg-white text-blue text-center opacity-0 translate-y-8">
                        <a href=""><Title title="HOME" className="text-8xl block mb-4 transition duration-500 italic font-bold w-fit mx-auto"/></a>
                        <a href=""><Title title="WORK" className="text-8xl block mb-4 transition duration-500 hover:font-bold w-fit mx-auto"/></a>
                        <a href=""><Title title="ABOUT" className="text-8xl block mb-4 transition duration-500 hover:font-bold w-fit mx-auto"/></a>
                        <a href=""><Title title="CONTACT" className="text-8xl block mb-4 transition duration-500 hover:font-bold w-fit mx-auto"/></a>
                    </div>
